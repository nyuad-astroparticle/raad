...
// ********************************************************************
//
// $Id: B4aDetectorConstruction.hh 75215 2013-10-29 16:07:06Z gcosmo $
//
/// \file B4aDetectorConstruction.hh
/// \brief Definition of the B4aDetectorConstruction class
...
class B4aDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    // get methods
    //
  //  const G4VPhysicalVolume* GetAbsorberPV() const; // --gianmarco
  // const G4VPhysicalVolume* GetGapPV() const;      // --gianmarco
  ...
  private:
    ...
    // data members
    //
   //    static G4ThreadLocal G4GlobalMagFieldMessenger*  fMagFieldMessenger; --gianmarco
