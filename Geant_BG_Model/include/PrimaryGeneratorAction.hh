...
private:
    ...
    G4int entries;                                                              // Number of entries on the probability density and the energies array
    G4double* probability;                                                      // Probability density function for the energies
    G4double* energies;                                                         // Energies for sampling
