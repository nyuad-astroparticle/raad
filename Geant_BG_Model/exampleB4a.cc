...
#include "FTFP_BERT.hh" // -- gianmarco -- original
//#include "Shielding.hh" // -- gianmarco
...
int main(int argc,char** argv)
{
  ...
  G4VModularPhysicsList* physicsList = new FTFP_BERT; // -- gianmarco --original
  //G4VModularPhysicsList* physicsList = new Shielding; // -- gianmarco
  ...
  //
    ...
    = new B4PrimaryGeneratorAction(eventAction);
